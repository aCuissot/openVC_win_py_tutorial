...
A = cv.imread('../../Data/in/pomme.png')
B = cv.imread('../../Data/in/orange.png')
...
cv.imwrite('../../Data/out/3.7.yramid_blending2.jpg', ls_)
cv.imwrite('../../Data/out/3.7.Direct_blending.jpg', real)
